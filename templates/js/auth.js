$(document).ready(function() {
    ...
    $(document).on('click', '.auth-forgot', function(e) {
        ...
        $.ajax({
            ...
            data: "login=" + $(".auth-block-tab-forgot .auth-forgot-login").val() + "&captcha=" + $(".auth-block-tab-forgot input[name=captcha]").val() + "&action=profile/forgot",
            dataType: "json",
            cache: false,
    ...
    $(document).on('click', '.action-auth-send', function(e) {
        ...
        $.ajax({
            type: "POST",
            url: url_path + "systems/ajax/controller.php",
            data: "user_login=" + $(".auth-block-tab-auth input[name=user_login]").val() + "&user_pass=" + $(".auth-block-tab-auth input[name=user_pass]").val() + "&save_auth=" + $(".auth-block-tab-auth input[name=save_auth]").val() + "&captcha=" + $(".auth-block-tab-auth input[name=captcha]").val() + "&action=profile/check_auth",
            dataType: "json",
            cache: false,
            success: function(data) {
    ...
    $(document).on('click', '.action-reg-send', function(e) {
        ...
        $.ajax({
            type: "POST",
            url: url_path + "systems/ajax/controller.php",
            data: "user_login=" + $(".auth-block-tab-reg input[name=user_login]").val() + "&captcha=" + $(".auth-block-tab-reg input[name=captcha]").val() + "&action=profile/registration",
            dataType: "json",
            cache: false,
            success: function(data) {
    ...
    $(document).on('click', '.action-reg-verify', function(e) {
        ...
        $.ajax({
            type: "POST",
            url: url_path + "systems/ajax/controller.php",
            data: "user_login=" + $(".auth-block-tab-reg input[name=user_login]").val() + "&user_code_login=" + $(".auth-block-tab-reg input[name=user_code_login]").val() + "&captcha=" + $(".auth-block-tab-reg input[name=captcha]").val() + "&action=profile/verify_login",
            dataType: "json",
            cache: false,
            success: function(data) {
    ...
    $(document).on('click', '.action-reg-finish', function(e) {
        ...
        $.ajax({
            type: "POST",
            url: url_path + "systems/ajax/controller.php",
            data: "user_login=" + $(".auth-block-tab-reg input[name=user_login]").val() + "&user_code_login=" + $(".auth-block-tab-reg input[name=user_code_login]").val() + "&user_pass=" + $(".auth-block-tab-reg input[name=user_pass]").val() + "&user_name=" + $(".auth-block-tab-reg input[name=user_name]").val() + "&action=profile/reg_finish",
            dataType: "json",
            cache: false,
            success: function(data) {
    ...
    $(document).on('click', '.event-point-auth', function() {
        $.ajax({
            type: "POST",
            url: url_path + "systems/ajax/controller.php",
            data: "location=" + document.location.href + "&action=profile/event_point_auth",
            dataType: "html",
            cache: false
        });
    });
